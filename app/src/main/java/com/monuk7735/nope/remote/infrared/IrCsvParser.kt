    ...
    fun parseCsvAndGenerateHex(csvContent: String, functionQuery: String? = null): Map<String, String> {
        ...
        for (i in 1 until lines.size) {
            ...
            val (generator: Protocol?, frequency: Int) = when {
                ...
                protocolName.equals("Samsung20", ignoreCase = true) -> Pair(Samsung20(), 38400)
                protocolName.equals("Samsung36", ignoreCase = true) -> Pair(Samsung36(), 38000)
                protocolName.startsWith("Samsung", ignoreCase = true) -> Pair(NECSamsung(), 38000)
